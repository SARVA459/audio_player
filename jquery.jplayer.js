...
!(function (a, b) {
    "function" == typeof define && define.amd
        ? define(["jquery"], b)
        : b("object" == typeof exports ? require("jquery") : a.jQuery ? a.jQuery : a.Zepto);
})(this, function (a, b) {
            ...
            return (
                a.jPlayer.browser.msie &&
                    (document.documentMode
                        ...
                        : ((b = 5), document.compatMode && "CSS1Compat" === document.compatMode && (b = 7))),
                b
            );
        }),
        ...
        (a.jPlayer.prototype = {
            ...
            _init: function () {
                ...
                if (
                    ...
                    (this.internal.cmdsIgnored =
                        a.jPlayer.platform.ipad || a.jPlayer.platform.iphone || a.jPlayer.platform.ipod),
                    ...
                    a.jPlayer.platform.android &&
                        (this.options.preload = "auto" !== this.options.preload ? "metadata" : "auto"),
                    (this.formats = []),
                    (this.solutions = []),
                    (this.require = {}),
                    (this.htmlElement = {}),
                    ...
                    this.require.video &&
                        ...
                        (this.html.video.available =
                            !!this.htmlElement.video.canPlayType && this._testCanPlayType(this.htmlElement.video))),
                    ...
                    a.each(this.formats, function (b, d) {
                        (c.html.canPlay[d] =
                            ...
                            "" !== c.htmlElement[c.format[d].media].canPlayType(c.format[d].codec)),
                    ...
                    if (
                        a.jPlayer.browser.msie &&
                        (Number(a.jPlayer.browser.version) < 9 || a.jPlayer.browser.documentMode < 9)
                    ) {
                        var f =
                                '<object id="' +
                ...
                (this.status.playbackRateEnabled =
                    this.html.used && !this.flash.used ? this._testPlaybackRate("audio") : !1),
            ...
            _addHtmlEventListeners: function (b, c) {
                ...
                (b.preload = this.options.preload),
                    ...
                    b.addEventListener(
                        ...
                        function () {
                            c.gate &&
                                (d._getHtmlStatus(b), d._updateInterface(), d._trigger(a.jPlayer.event.timeupdate));
                        },
                        !1
                    ),
                    b.addEventListener(
                        ...
                        function () {
                            c.gate &&
                                (d._getHtmlStatus(b), d._updateInterface(), d._trigger(a.jPlayer.event.durationchange));
                        },
                        !1
                    ),
                    b.addEventListener(
                        ...
                        function () {
                            c.gate &&
                                (d._updateButtons(!0), d._html_checkWaitForPlay(), d._trigger(a.jPlayer.event.play));
                        },
                        !1
                    ),
                    b.addEventListener(
                    ...
                    b.addEventListener(
                        ...
                        function () {
                            c.gate &&
                                (a.jPlayer.browser.webkit || (d.htmlElement.media.currentTime = 0),
                    ...
                    a.buffered > 0
                        ? ((e =
                              this.status.duration > 0
                                  ...
                                  : 100),
                          (f = this.status.duration > 0 ? c / (a.buffered * this.status.duration) : 0))
                        : ((e = 100), (f = d)),
                    b && ((c = 0), (f = 0), (d = 0)),
                    (this.status.seekPercent = e),
                    (this.status.currentPercentRelative = f),
                ...
                this.css.jq.seekBar.length && this.css.jq.seekBar.width(this.status.seekPercent + "%"),
                    this.css.jq.playBar.length &&
                        (this.options.smoothPlayBar
                            ? this.css.jq.playBar
                                  .stop()
                                  .animate({ width: this.status.currentPercentAbsolute + "%" }, 250, "linear")
                ...
                this.css.jq.duration.length &&
                    ("string" == typeof this.status.media.duration
                        ...
                        : ("number" == typeof this.status.media.duration &&
                              ((c = this.status.media.duration), (d = c - this.status.currentTime)),
                                        ...
                                        g
                                            ? (i
                                                  ? ((c.html.video.gate = !0),
                                                    c._html_setVideo(b),
                                                    (c.html.active = !0))
                                                  : ((c.flash.gate = !0), c._flash_setVideo(b), (c.flash.active = !0)),
                                            ...
                                            : (i
                                                  ? ((c.html.audio.gate = !0),
                                                    c._html_setAudio(b),
                                                    (c.html.active = !0),
                                                    a.jPlayer.platform.android && (c.androidFix.setMedia = !0))
                                                  : j
                                                    ? ((c.aurora.gate = !0),
                    ...
                    d
                        ? ((this.status.nativeVideoControls && this.html.video.gate) ||
                              (this._validString(b.poster) &&
                                  (e ? (this.htmlElement.poster.src = b.poster) : this.internal.poster.jq.show())),
            ...
            volumeWorker: function (b) {
                (b = this._limitValue(b, 0, 1)),
                    ...
                    this.html.video.gate ||
                        this.html.audio.gate ||
                        (this._updateVolume(b), this._trigger(a.jPlayer.event.volumechange));
            },
                    ...
                    this.status.noVolume
                        ...
                        : (this.removeStateClass("noVolume"),
                          ...
                          this.css.jq.volumeBarValue.length &&
                              ...
                              this.css.jq.volumeBarValue[this.options.verticalVolume ? "height" : "width"](
                                  100 * a + "%"
                              )),
            ...
            playbackRateBar: function (b) {
                if (this.css.jq.playbackRateBar.length) {
                    ...
                    (c = this.options.verticalPlaybackRate ? i / j : g / h),
                        (d =
                            c * (this.options.maxPlaybackRate - this.options.minPlaybackRate) +
                ...
                this.status.playbackRateEnabled
                    ? (this.css.jq.playbackRateBar.length && this.css.jq.playbackRateBar.show(),
                      this.css.jq.playbackRateBarValue.length &&
                          ...
                          this.css.jq.playbackRateBarValue[this.options.verticalPlaybackRate ? "height" : "width"](
                              100 * b + "%"
                          )))
            ...
            _setOption: function (b, c) {
                ...
                switch (b) {
                    ...
                    case "playbackRate":
                        (this.options[b] = c =
                            this._limitValue(c, this.options.minPlaybackRate, this.options.maxPlaybackRate)),
                    ...
                    case "minPlaybackRate":
                        (this.options[b] = c = this._limitValue(c, 0.1, this.options.maxPlaybackRate - 0.1)),
                            this._updatePlaybackRate();
                        break;
                    case "maxPlaybackRate":
                        (this.options[b] = c = this._limitValue(c, this.options.minPlaybackRate + 0.1, 16)),
                            this._updatePlaybackRate();
                        break;
                    case "fullScreen":
                        if (this.options[b] !== c) {
                    ...
                    case "emulateHtml":
                        this.options[b] !== c &&
                            ((this.options[b] = c), c ? this._emulateHtmlBridge() : this._destroyHtmlBridge());
                        break;
                    case "timeFormat":
                        this.options[b] = a.extend({}, this.options[b], c);
                        break;
            ...
            _fullscreenRemoveEventListeners: function () {
                ...
                this.internal.fullscreenchangeHandler &&
                    document.removeEventListener(b.event.fullscreenchange, this.internal.fullscreenchangeHandler, !1);
            },
            ...
            _html_setFormat: function (b) {
                ...
                a.each(this.formats, function (a, d) {
                    return c.html.support[d] && b[d]
                        ? ((c.status.src = b[d]), (c.status.format[d] = !0), (c.status.formatType = d), !1)
                        : void 0;
                });
            },
            ...
            _aurora_mute: function (a) {
                a
                    ? ((this.aurora.properties.lastvolume = this.aurora.player.volume), (this.aurora.player.volume = 0))
                ...
                if (window.ActiveXObject)
                    try {
                        if ((a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))) {
                            ...
                            c &&
                                ((c = c.split(" ")[1].split(",")), (b = parseInt(c[0], 10) + "." + parseInt(c[1], 10)));
                        }
                    } catch (d) {}
                else
                    navigator.plugins &&
