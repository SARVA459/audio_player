        ...
        (jPlayerPlaylist.prototype = {
            ...
            _createListItem: function (b) {
                ...
                return (
                    (d +=
                        ...
                        "' tabindex='0'>" +
                        b.title +
                        (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") +
                        "</a>"),
                    (d += "</div></li>")
                );
            },
            _createItemHandlers: function () {
                ...
                a(this.cssSelector.playlist)
                    ...
                    .on("click", "a." + this.options.playlistOptions.itemClass, function (c) {
                        c.preventDefault();
                    ...
                    a(this.cssSelector.playlist)
                        ...
                        .on("click", "a." + this.options.playlistOptions.freeItemClass, function (c) {
                            c.preventDefault(),
                                a(this)
                                    .parent()
                                    .parent()
                    ...
                    a(this.cssSelector.playlist)
                        ...
                        .on("click", "a." + this.options.playlistOptions.removeItemClass, function (c) {
                            c.preventDefault();
                            var d = a(this).parent().parent().index();
                    ...
                    : this.removing
                      ...
                      : ((c = 0 > c ? d.original.length + c : c),
                        c >= 0 &&
                            ...
                            ((this.removing = !0),
                            a(this.cssSelector.playlist + " li:nth-child(" + (c + 1) + ")").slideUp(
                                ...
                                function () {
                                    ...
                                    d.original.length
                                        ? c === d.current
                                            ? ((d.current = c < d.original.length ? d.current : d.original.length - 1),
                                              d.select(d.current))
            ...
            play: function (c) {
                (c = 0 > c ? this.original.length + c : c),
                    c >= 0 && c < this.playlist.length
                        ? this.playlist.length && (this.select(c), a(this.cssSelector.jPlayer).jPlayer("play"))
            ...
            next: function () {
                ...
                this.loop
                    ? 0 === a && this.shuffled && this.options.playlistOptions.shuffleOnLoop && this.playlist.length > 1
                        ? this.shuffle(!0, !0)
                        : this.play(a)
                    : a > 0 && this.play(a);
            },
            previous: function () {
                ...
                ((this.loop && this.options.playlistOptions.loopOnPrevious) || a < this.playlist.length - 1) &&
                    this.play(a);
            },
